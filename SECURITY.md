...
Relay is under pilot-readiness development. A report, patch, test, or Release artifact does not make it suitable for real-disaster emergency dispatch. See [municipal pilot readiness](docs/readiness/MUNICIPAL_PILOT_READINESS.md).
