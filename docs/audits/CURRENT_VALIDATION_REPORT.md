...
| Jazzer fuzzing | .clusterfuzzlite JVM targets and ClusterFuzzLite PR workflow | PENDING CI | Standalone QrFrameFuzzer and GatewayMessageFuzzer entry points now exercise production decoders; final PASS requires the PR workflow run. |
